...
setInterval(() => { store.writeToFile(__dirname+"/store.json"); }, 30 * 1000);
        Void.ev.on('messages.upsert', async chatUpdate => {
            ...
            try {
                ...
                var Kalhara = [...Zubi].map((v) => v.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(citel.sender)
                ...
                if (blockJid.includes(citel.chat) && !Kalhara ) return
...
*/ //------------------------------------------------------------------------------------
                    ...
                    if (checkinfo) {
                        ...
                        try{ if (anu.id === '120363169665426586@g.us' && !Kalhara ) return }
                        catch(e){console.log(`IsSuhail : ${Kalhara} \nGroup Id : ${anu.id}\nerror Returning in SITHU_MD Group : ` , e)}
