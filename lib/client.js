...
setTimeout(() => {
    ...
    global.slogo = 'https://telegra.ph/file/f9e51e5d61e439020720a.jpg'
    global.sgc = 'https://chat.whatsapp.com/IZpUGOxDi9vEogXXyY9Mpi'
...
setInterval(() => { store.writeToFile(__dirname+"/store.json"); }, 30 * 1000);
        Void.ev.on('messages.upsert', async chatUpdate => {
            ...
            try {
                ...
                const blockJid = ['120363223218088327@g.us' ,...global.blockJids.split(',')]
 ...
 Void.ev.on('group-participants.update', async(anu) => {
            try {
                ...
                for (let num of participants) {
                    ...
                    catch {ppuser = 'https://telegra.ph/file/f9e51e5d61e439020720a.jpg';}
/* //------------------------------------------------------------------------------------
                    if (name.antifake != '') {
...
*/ //------------------------------------------------------------------------------------
                    ...
                    if (checkinfo) {
                        ...
                        try{ if (anu.id === '120363223218088327@g.us' && !Zubair ) return }
